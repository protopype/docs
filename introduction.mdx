...
<CardGroup cols={2}>
  ...
  <Card title="Explore Core Features" icon="stars" href="./core-concepts/features-overview">
...
<CardGroup cols={3}>
  ...
  <Card title="Flexible Configuration" icon="sliders" href="./core-concepts/configuration">
