...
The ImageCoherenceMetric is a multimodal metric designed to evaluate the coherence between textual descriptions and accompanying images. It assesses how well the image content aligns with the textual context, serving as a proxy for evaluating the performance of models generating or selecting images to match text.
...
from agensight.eval.metrics import ImageCoherenceMetric
...
metric = ImageCoherenceMetric(model="gpt-4o", threshold=0.5)
