...
The MultimodalContextualRelevancyMetric is a multimodal metric designed to evaluate the relevancy of generated outputs in relation to the provided context. It assesses how well the generated output aligns with the relevant context, serving as a proxy for evaluating the performance of models that generate text based on multimodal inputs.
...
from agensight.eval.metrics import MultimodalContextualRelevancyMetric
...
metric = MultimodalContextualRelevancyMetric(model="gpt-4o", threshold=0.5)
